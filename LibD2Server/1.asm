...
aMyLogo db 'Version 1.11b patch build 45 by marsgod. 2010-03-07',0
...
;CreateEventA	dd 006BF510h
;SetEvent	dd 6800B010h
;WaitForSingleObject	dd 006BF520h
;CreateMutexA	dd 006BF4ECh
;CloseHandle	dd 006BF51Ch
;CreateThread	dd 006BF514h
;GetExitCodeThread	dd 006BF508h
;TerminateThread	dd 006BF494h
;Sleep	dd 006BF4F4h
;InitializeCriticalSection	dd 006BF4E4h
;EnterCriticalSection	dd 006BF528h
;LeaveCriticalSection	dd 006BF52Ch
;DeleteCriticalSection	dd 006BF4E0h
...
aTradeHandleMsg db 'TradeHandle Enabled.',0
aPickHandleMsg db 'PickHandle Enabled.',0
aNPCHandleMsg db 'NPCHandle Enabled.',0
...
TradeOrginalCall	dd 0	;d2game.dll		RVA:00038E32
...
;      add eax, [ecx]
;      add eax, 4
;      mov TradeOrginalCall, eax
;	mov eax,offset tradeHandler
;      sub eax, ecx
;      sub eax, 4
;	mov [ecx],eax

;	push    offset aTradeHandleMsg
;	push    offset aD2Server
;	mov eax,D2GS_EventLog_off
;	mov eax,[eax]
;	call    eax
